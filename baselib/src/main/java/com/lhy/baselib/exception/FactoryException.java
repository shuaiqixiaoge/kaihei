...
public class FactoryException {
     ...
     * @return
     */
    public static HttpApiException analysisExcetpion(Throwable e) {
        HttpApiException apiException = new HttpApiException(e);
        ...
        } else if (e instanceof JsonIOException || e instanceof JsonParseException || e instanceof JsonSyntaxException) {
             /*fastjson解析异常*/
