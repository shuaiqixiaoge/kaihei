 ...
 * package_name is com.lhy.baselib.network
 * 描述:URL地址控制
 */
...
//    public static final String HOST_URL = "http://192.168.1.10:8080";//测试地址
    ...
    public static final String getImg(String imgUrl) {
        return HOST_URL + imgUrl;
    }

//    public static final String HOST_URL = "http://wyj.xueshengtai.com";//正式地址
