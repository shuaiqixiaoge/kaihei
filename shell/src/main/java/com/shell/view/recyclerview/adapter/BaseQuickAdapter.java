...
import com.shell.view.recyclerview.adapter.animation.AlphaInAnimation;
import com.shell.view.recyclerview.adapter.animation.BaseAnimation;
import com.shell.view.recyclerview.adapter.animation.ScaleInAnimation;
import com.shell.view.recyclerview.adapter.animation.SlideInBottomAnimation;
import com.shell.view.recyclerview.adapter.animation.SlideInLeftAnimation;
import com.shell.view.recyclerview.adapter.animation.SlideInRightAnimation;
import com.shell.view.recyclerview.adapter.entity.IExpandable;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
     ...
     * @param payloads
     */
    public void updateData(int fromPosition, int toPosition, Object payloads) {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position, List<Object> payloads) {
        ...
        switch (viewType) {
            case 0:
                convert(holder, mData.get(holder.getLayoutPosition() - getHeaderLayoutCount()), payload);
                break;
            case HEADER_VIEW:
                break;
            case EMPTY_VIEW:
    ...
    protected void convert(BaseViewHolder holder, T item, Object payload) {
        convert(holder, item);
    }
