...
import com.shell.R;
import com.shell.view.recyclerview.adapter.callback.ItemDragAndSwipeCallback;
import com.shell.view.recyclerview.adapter.listener.OnItemDragListener;
import com.shell.view.recyclerview.adapter.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T> extends BaseQuickAdapter<T> {
    ...
    private static final String ERROR_NOT_SAME_ITEM_TOUCH_HELPER = "Item drag and item swipe should pass the same ItemTouchHelper";
