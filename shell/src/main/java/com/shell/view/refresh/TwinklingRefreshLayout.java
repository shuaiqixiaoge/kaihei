...
import com.shell.R;
import com.shell.view.refresh.Footer.BallPulseView;
import com.shell.view.refresh.header.GoogleDotView;
import com.shell.view.refresh.processor.AnimProcessor;
import com.shell.view.refresh.processor.IDecorator;
import com.shell.view.refresh.processor.OverScrollDecorator;
import com.shell.view.refresh.processor.RefreshProcessor;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mMaxBottomHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_max_bottom_height, (int) DensityUtil.dp2px(context, 100));
            mBottomHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_bottom_height, (int) DensityUtil.dp2px(context, 50));
    ...
    public void setEnableLoadMore(boolean enableLoadmore1) {
        ...
        if (mBottomView != null) {
            if (enableLoadmore) mBottomView.show();
            else mBottomView.hide();
        }
    }
    ...
    public void setEnableRefresh(boolean enableRefresh1) {
        ...
        if (mHeadView != null) {
            if (enableRefresh) mHeadView.show();
            else mHeadView.hide();
        }
    }
    ...
    public void onPullingDown(TwinklingRefreshLayout refreshLayout, float fraction) {
        mHeadView.onPullingDown(fraction, mMaxHeadHeight, mHeadHeight, enableRefresh);
        if (refreshListener != null) refreshListener.onPullingDown(refreshLayout, fraction);
    }

    @Override
    public void onPullingUp(TwinklingRefreshLayout refreshLayout, float fraction) {
        mBottomView.onPullingUp(fraction, mMaxHeadHeight, mHeadHeight, enableLoadmore);
        if (refreshListener != null) refreshListener.onPullingUp(refreshLayout, fraction);
    }

    @Override
    public void onPullDownReleasing(TwinklingRefreshLayout refreshLayout, float fraction) {
        mHeadView.onPullReleasing(fraction, mMaxHeadHeight, mHeadHeight, enableRefresh);
        if (refreshListener != null)
    ...
    public void onPullUpReleasing(TwinklingRefreshLayout refreshLayout, float fraction) {
        mBottomView.onPullReleasing(fraction, mMaxBottomHeight, mBottomHeight, enableLoadmore);
        if (refreshListener != null) refreshListener.onPullUpReleasing(refreshLayout, fraction);
    }

    @Override
    public void onRefresh(TwinklingRefreshLayout refreshLayout) {
        mHeadView.startAnim(mMaxHeadHeight, mHeadHeight, enableRefresh);
    ...
    public void onLoadMore(TwinklingRefreshLayout refreshLayout) {
        mBottomView.startAnim(mMaxBottomHeight, mBottomHeight, enableLoadmore);
    ...
    public void onFinishLoadMore() {
        ...
        mBottomView.onFinish(enableLoadmore);
    }
